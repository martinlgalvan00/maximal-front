    ...
    return (
        ...
        <footer className="container-fluid bg-dark mt-5">
            <div className="row">
                ...
                <p className="text-muted text-center mt-3">&copy; 2023 | Sitio realizado por Martin Galvan  <a target="_blank" href="https://wa.me/message/6PSH46QCW4OTP1" className="text-muted col-2 mx-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-whatsapp" viewBox="0 0 16 16">
